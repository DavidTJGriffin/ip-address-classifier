# David Griffin
# CIS156 Fall 2024 Module 4 Programming Assignment
# Part B
# This program uses conditional statements, string manipulation, and list manipulation to categorize IPv4 address entered by user. 
